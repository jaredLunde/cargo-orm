...
class TestBit(configure.BitTestCase, TestField):
    '''
    ...
    def test_type_name(self):
        self.assertEqual(self.base.type_name, 'bit(4)')
        self.assertEqual(self.base_array.type_name, 'bit(4)[]')


if __name__ == '__main__':
    # Unit test
    configure.run_tests(TestBit, verbosity=2, failfast=True)
