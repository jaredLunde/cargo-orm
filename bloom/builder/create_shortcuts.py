...
def create_table(*args, dry=False, **kwargs):
    """ `Create a Table`
        ...
        @*column: (:class:Field|:class:bloom.builders.tables.Column)
        ...
        @on_commit: (#str|:class:Clause) one of |PRESERVE ROWS|,
            |DELETE ROWS|, |DROP|
        @inherits: (#str|#tuple(#str)) name or names of the tables to
            inherit from
...
def create_index(*args, dry=False, **kwargs):
    """ @orm: (:class:ORM)
        @field: (#str|:class:Field) the field to create an index on
        ...
        @order: (#str|:class:Clause) |ASC| or |DESC|
        @nulls: (#str|:class:Clause) |FIRST| or |LAST
        ...
        @partial: (#str|:class:BaseExpression) sets the |WHERE| clause
            for partial indexes
        @dry: (#bool) |True| to execute the query before returning
...
def create_sequence(*args, dry=False, **kwargs):
    """ @orm: (:class:ORM)
        ...
        @cycle: (#bool) The CYCLE option allows the sequence to wrap around
            ...
            respectively.
        @owned_by: (#str|:class:Field) The OWNED BY option causes the
...
def create_function(*args, dry=False, **kwargs):
    """ @orm: (:class:ORM)
        @function: (#str|:class:Function) name of the function with arguments
            e.g. |func(arg1 int, arg2 text)| or
            |Function('func', safe('arg1 int'), safe('arg2 text'))|
        @arg: (#str|:class:BaseExpression) function arguments in the form of
            |[argmode ] [ argname ] argtype [ { DEFAULT | = } default_expr|
        @expression: (#str|:class:BaseExpression|:class:Query) the function
            context. This is the expression that gets executed when the
            function is called.
...
def create_role(orm, name, *options, in_role=None, in_group=None, role=None,
    ...
    """ @orm: (:class:ORM)
        ...
        @*options: (#str|:class:Clause) names of role options
...
def create_trigger(*args, dry=False, **kwargs):
    """ @orm: (:class:ORM)
        ...
        @at: (#str|:class:Clause) |BEFORE|, |AFTER| or |INSTEAD OF|;
            determines whether the function is called before or after
            the event.
        @*events: (#str|:class:Clause) one of |INSERT, |UPDATE [OF col]|,
        ...
        @type: (#str|:class:Clause) |ROW| or |STATEMENT|; specifies whether
            the trigger procedure should be fired once for every row affected.
            by the trigger event, or just once per SQL statement.
        @function: (#str|:class:Function) user-supplied function that which is
        ...
        @timing: (#str|:class:Clause) one of:
            ...
            * |INITIALLY IMMEDIATE|
            * |INITIALLY DEFERRED|
        @condition: (#str|:class:Expression) boolean expression that
...
def create_cast(*args, dry=False, **kwargs):
    """ @orm: (:class:ORM)
        ...
        @function: (#str|:class:Function) The function used to perform
...
def create_domain(*args, dry=False, **kwargs):
    """ @orm: (:class:ORM)
        ...
        @not_null: (#bool) |True| if values of this domain are not allowed
            to be null.
        @check: (#str|:class:Expression) specify integrity constraints or
...
def create_rule(*args, dry=False, **kwargs):
    """ @orm: (:class:ORM)
        ...
        @command: (#str|:class:Expression) command  that makes up
            the rule action
        @also: (#bool) |True| adds an |ALSO| flag to the |DO| command
        @condition: (#str|:class:BaseExpression) boolean expression
