"""
  ...
  `Bloom SQL shortcut functions for creating tables, models, role, etc`
--·--·--·--·--·--·--·--·--·--·--·--·--·--·--·--·--·--·--·--·--·--·--·--·--·--·--
...
from bloom.builder.indexes import Index
...
from bloom.builder.sequences import Sequence
from bloom.builder.tables import Table
from bloom.builder.tablespaces import Tablespace
from bloom.builder.triggers import Trigger
from bloom.builder.types import Type, EnumType, RangeType
...
def create_table(*args, dry=False, **kwargs):
    """ `Create a Table`
        @orm: (:class:ORM)
        @name: (#str) name of the table
        @*column: (:class:Field or :class:bloom.builders.tables.Column)
