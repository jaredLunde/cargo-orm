...
from bloom.builder.create_shortcuts import create_sequence, create_schema
...
class UIDFunction(Function):
    """ ========================================================================
        ...
        * 10-bit representation of an auto-incrementing sequence, modulus 1024.
        ...
        To use, set the |uid| field default value to |{schema}.bloom_uid()|
    ...
    """
    extras_name = 'bloom_uid'

    def __init__(self, orm, shard_id=-1, name='bloom_uid', schema=None,
                 epoch=None, seq_cache=1024,  seq_name='bloom_uid_seq',
                 replace=False):
        """ `UID Function`
            @schema: (#str)
            ...
            @seq_name: (#str) name of the sequence to create for this function.
                See also :class:bloom.builder.create_sequence
